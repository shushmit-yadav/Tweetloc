...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public DummyPostRequest dummyPostRequest(java.util.List<java.lang.String> groupMember) throws java.io.IOException {
    DummyPostRequest result = new DummyPostRequest(groupMember);
    initialize(result);
    return result;
  }
  ...
  public class DummyPostRequest extends TweetApiRequest<Void> {
    ...
    private static final String REST_PATH = "dummyPostRequest/{group_member}";
     ...
     * @since 1.13
     */
    protected DummyPostRequest(java.util.List<java.lang.String> groupMember) {
