...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetGRoupDetailUsingKey extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.GroupBean> {

    private static final String REST_PATH = "groupbean/{id}";
    ...
    protected GetGRoupDetailUsingKey(java.lang.String id) {
      super(TweetApi.this, "GET", REST_PATH, null, com.brahminno.tweetloc.backend.tweetApi.model.GroupBean.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
