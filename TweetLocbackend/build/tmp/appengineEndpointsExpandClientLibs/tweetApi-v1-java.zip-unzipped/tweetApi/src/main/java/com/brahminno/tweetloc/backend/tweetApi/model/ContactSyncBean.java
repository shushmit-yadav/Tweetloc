...
public final class ContactSyncBean extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<java.lang.String> numberList;

  /**
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getNumberList() {
    return numberList;
  }

  /**
   * @param numberList numberList or {@code null} for none
   */
  public ContactSyncBean setNumberList(java.util.List<java.lang.String> numberList) {
