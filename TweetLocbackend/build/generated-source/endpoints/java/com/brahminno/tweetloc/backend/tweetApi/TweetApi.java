...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ContactSync extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.RegistrationBeanCollection> {
    ...
    protected ContactSync(java.util.List<java.lang.String> number) {
      super(TweetApi.this, "POST", REST_PATH, null, com.brahminno.tweetloc.backend.tweetApi.model.RegistrationBeanCollection.class);
