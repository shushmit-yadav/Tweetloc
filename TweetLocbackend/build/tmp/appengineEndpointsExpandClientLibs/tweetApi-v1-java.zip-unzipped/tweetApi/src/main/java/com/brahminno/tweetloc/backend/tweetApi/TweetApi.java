...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getGRoupDetailUsingKey".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link GetGRoupDetailUsingKey#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
   */
  public GetGRoupDetailUsingKey getGRoupDetailUsingKey(java.lang.String id) throws java.io.IOException {
    GetGRoupDetailUsingKey result = new GetGRoupDetailUsingKey(id);
    initialize(result);
    return result;
  }

  public class GetGRoupDetailUsingKey extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.GroupBeanCollection> {

    private static final String REST_PATH = "groupbeancollection/{id}";

    /**
     * Create a request for the method "getGRoupDetailUsingKey".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link GetGRoupDetailUsingKey#execute()} method to invoke the
     * remote operation. <p> {@link GetGRoupDetailUsingKey#initialize(com.google.api.client.googleapis
     ...
     * @since 1.13
     */
    protected GetGRoupDetailUsingKey(java.lang.String id) {
      super(TweetApi.this, "GET", REST_PATH, null, com.brahminno.tweetloc.backend.tweetApi.model.GroupBeanCollection.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    @Override
    public GetGRoupDetailUsingKey setAlt(java.lang.String alt) {
      return (GetGRoupDetailUsingKey) super.setAlt(alt);
    }

    @Override
    public GetGRoupDetailUsingKey setFields(java.lang.String fields) {
      return (GetGRoupDetailUsingKey) super.setFields(fields);
    }

    @Override
    public GetGRoupDetailUsingKey setKey(java.lang.String key) {
      return (GetGRoupDetailUsingKey) super.setKey(key);
    }

    @Override
    public GetGRoupDetailUsingKey setOauthToken(java.lang.String oauthToken) {
      return (GetGRoupDetailUsingKey) super.setOauthToken(oauthToken);
    }

    @Override
    public GetGRoupDetailUsingKey setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetGRoupDetailUsingKey) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetGRoupDetailUsingKey setQuotaUser(java.lang.String quotaUser) {
      return (GetGRoupDetailUsingKey) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetGRoupDetailUsingKey setUserIp(java.lang.String userIp) {
      return (GetGRoupDetailUsingKey) super.setUserIp(userIp);
    }
    ...
    public GetGRoupDetailUsingKey setId(java.lang.String id) {
      this.id = id;
      return this;
    }

    @Override
    public GetGRoupDetailUsingKey set(String parameterName, Object value) {
      return (GetGRoupDetailUsingKey) super.set(parameterName, value);
    }
  }
