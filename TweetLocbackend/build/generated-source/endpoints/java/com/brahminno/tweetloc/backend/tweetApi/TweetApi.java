...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ContactSync contactSync(java.util.List<java.lang.String> number) throws java.io.IOException {
    ContactSync result = new ContactSync(number);
    initialize(result);
    return result;
  }

  public class ContactSync extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.ContactSyncBeanCollection> {

    private static final String REST_PATH = "contactSync/{number}";
     ...
     * @since 1.13
     */
    protected ContactSync(java.util.List<java.lang.String> number) {
      super(TweetApi.this, "POST", REST_PATH, null, com.brahminno.tweetloc.backend.tweetApi.model.ContactSyncBeanCollection.class);
    ...
    public ContactSync setNumber(java.util.List<java.lang.String> number) {
      this.number = number;
      return this;
    }
  ...
  /**
   * Create a request for the method "testStoreArrayListTest".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link TestStoreArrayListTest#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.ContactSyncBean}
   * @return the request
   */
  public TestStoreArrayListTest testStoreArrayListTest(com.brahminno.tweetloc.backend.tweetApi.model.ContactSyncBean content) throws java.io.IOException {
    TestStoreArrayListTest result = new TestStoreArrayListTest(content);
    initialize(result);
    return result;
  }

  public class TestStoreArrayListTest extends TweetApiRequest<Void> {

    private static final String REST_PATH = "testStoreArrayListTest";

    /**
     * Create a request for the method "testStoreArrayListTest".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link TestStoreArrayListTest#execute()} method to invoke the
     * remote operation. <p> {@link TestStoreArrayListTest#initialize(com.google.api.client.googleapis
     ...
     * @since 1.13
     */
    protected TestStoreArrayListTest(com.brahminno.tweetloc.backend.tweetApi.model.ContactSyncBean content) {
      super(TweetApi.this, "POST", REST_PATH, content, Void.class);
    }

    @Override
    public TestStoreArrayListTest setAlt(java.lang.String alt) {
      return (TestStoreArrayListTest) super.setAlt(alt);
    }

    @Override
    public TestStoreArrayListTest setFields(java.lang.String fields) {
      return (TestStoreArrayListTest) super.setFields(fields);
    }

    @Override
    public TestStoreArrayListTest setKey(java.lang.String key) {
      return (TestStoreArrayListTest) super.setKey(key);
    }

    @Override
    public TestStoreArrayListTest setOauthToken(java.lang.String oauthToken) {
      return (TestStoreArrayListTest) super.setOauthToken(oauthToken);
    }

    @Override
    public TestStoreArrayListTest setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (TestStoreArrayListTest) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public TestStoreArrayListTest setQuotaUser(java.lang.String quotaUser) {
      return (TestStoreArrayListTest) super.setQuotaUser(quotaUser);
    }

    @Override
    public TestStoreArrayListTest setUserIp(java.lang.String userIp) {
      return (TestStoreArrayListTest) super.setUserIp(userIp);
    }

    @Override
    public TestStoreArrayListTest set(String parameterName, Object value) {
      return (TestStoreArrayListTest) super.set(parameterName, value);
    }
  }
