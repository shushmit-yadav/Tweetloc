...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "addAnotherGroupMember".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link AddAnotherGroupMember#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.GroupBean}
   * @return the request
   */
  public AddAnotherGroupMember addAnotherGroupMember(com.brahminno.tweetloc.backend.tweetApi.model.GroupBean content) throws java.io.IOException {
    AddAnotherGroupMember result = new AddAnotherGroupMember(content);
    initialize(result);
    return result;
  }

  public class AddAnotherGroupMember extends TweetApiRequest<Void> {

    private static final String REST_PATH = "addAnotherGroupMember";

    /**
     * Create a request for the method "addAnotherGroupMember".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link AddAnotherGroupMember#execute()} method to invoke the
     * remote operation. <p> {@link AddAnotherGroupMember#initialize(com.google.api.client.googleapis.
     ...
     * @since 1.13
     */
    protected AddAnotherGroupMember(com.brahminno.tweetloc.backend.tweetApi.model.GroupBean content) {
      super(TweetApi.this, "POST", REST_PATH, content, Void.class);
    }

    @Override
    public AddAnotherGroupMember setAlt(java.lang.String alt) {
      return (AddAnotherGroupMember) super.setAlt(alt);
    }

    @Override
    public AddAnotherGroupMember setFields(java.lang.String fields) {
      return (AddAnotherGroupMember) super.setFields(fields);
    }

    @Override
    public AddAnotherGroupMember setKey(java.lang.String key) {
      return (AddAnotherGroupMember) super.setKey(key);
    }

    @Override
    public AddAnotherGroupMember setOauthToken(java.lang.String oauthToken) {
      return (AddAnotherGroupMember) super.setOauthToken(oauthToken);
    }

    @Override
    public AddAnotherGroupMember setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (AddAnotherGroupMember) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public AddAnotherGroupMember setQuotaUser(java.lang.String quotaUser) {
      return (AddAnotherGroupMember) super.setQuotaUser(quotaUser);
    }

    @Override
    public AddAnotherGroupMember setUserIp(java.lang.String userIp) {
      return (AddAnotherGroupMember) super.setUserIp(userIp);
    }

    @Override
    public AddAnotherGroupMember set(String parameterName, Object value) {
      return (AddAnotherGroupMember) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "dummyPostRequest".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link DummyPostRequest#execute()} method to invoke the remote operation.
   *
   * @param groupMember
   * @param groupName
   * @return the request
   */
  public DummyPostRequest dummyPostRequest(java.util.List<java.lang.String> groupMember, java.lang.String groupName) throws java.io.IOException {
    DummyPostRequest result = new DummyPostRequest(groupMember, groupName);
    initialize(result);
    return result;
  }

  public class DummyPostRequest extends TweetApiRequest<Void> {

    private static final String REST_PATH = "dummyPostRequest/{group_member}/{groupName}";

    /**
     * Create a request for the method "dummyPostRequest".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link DummyPostRequest#execute()} method to invoke the remote
     * operation. <p> {@link DummyPostRequest#initialize(com.google.api.client.googleapis.services.Abs
     ...
     * @since 1.13
     */
    protected DummyPostRequest(java.util.List<java.lang.String> groupMember, java.lang.String groupName) {
      super(TweetApi.this, "POST", REST_PATH, null, Void.class);
      this.groupMember = com.google.api.client.util.Preconditions.checkNotNull(groupMember, "Required parameter groupMember must be specified.");
    ...
    @Override
    public DummyPostRequest setAlt(java.lang.String alt) {
      return (DummyPostRequest) super.setAlt(alt);
    }

    @Override
    public DummyPostRequest setFields(java.lang.String fields) {
      return (DummyPostRequest) super.setFields(fields);
    }

    @Override
    public DummyPostRequest setKey(java.lang.String key) {
      return (DummyPostRequest) super.setKey(key);
    }

    @Override
    public DummyPostRequest setOauthToken(java.lang.String oauthToken) {
      return (DummyPostRequest) super.setOauthToken(oauthToken);
    }

    @Override
    public DummyPostRequest setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (DummyPostRequest) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public DummyPostRequest setQuotaUser(java.lang.String quotaUser) {
      return (DummyPostRequest) super.setQuotaUser(quotaUser);
    }

    @Override
    public DummyPostRequest setUserIp(java.lang.String userIp) {
      return (DummyPostRequest) super.setUserIp(userIp);
    }
    ...
    public DummyPostRequest setGroupMember(java.util.List<java.lang.String> groupMember) {
    ...
    public DummyPostRequest setGroupName(java.lang.String groupName) {
      this.groupName = groupName;
      return this;
    }

    @Override
    public DummyPostRequest set(String parameterName, Object value) {
      return (DummyPostRequest) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "forgetEntityFromGroup".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link ForgetEntityFromGroup#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean}
   * @return the request
   */
  public ForgetEntityFromGroup forgetEntityFromGroup(com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean content) throws java.io.IOException {
    ForgetEntityFromGroup result = new ForgetEntityFromGroup(content);
    initialize(result);
    return result;
  }

  public class ForgetEntityFromGroup extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean> {

    private static final String REST_PATH = "forgetEntityFromGroup";

    /**
     * Create a request for the method "forgetEntityFromGroup".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link ForgetEntityFromGroup#execute()} method to invoke the
     * remote operation. <p> {@link ForgetEntityFromGroup#initialize(com.google.api.client.googleapis.
     * services.AbstractGoogleClientRequest)} must be called to initialize this instance immediately
     * after invoking the constructor. </p>
     *
     * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean}
     * @since 1.13
     */
    protected ForgetEntityFromGroup(com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean content) {
      super(TweetApi.this, "POST", REST_PATH, content, com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean.class);
    }

    @Override
    public ForgetEntityFromGroup setAlt(java.lang.String alt) {
      return (ForgetEntityFromGroup) super.setAlt(alt);
    }

    @Override
    public ForgetEntityFromGroup setFields(java.lang.String fields) {
      return (ForgetEntityFromGroup) super.setFields(fields);
    }

    @Override
    public ForgetEntityFromGroup setKey(java.lang.String key) {
      return (ForgetEntityFromGroup) super.setKey(key);
    }

    @Override
    public ForgetEntityFromGroup setOauthToken(java.lang.String oauthToken) {
      return (ForgetEntityFromGroup) super.setOauthToken(oauthToken);
    }

    @Override
    public ForgetEntityFromGroup setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ForgetEntityFromGroup) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ForgetEntityFromGroup setQuotaUser(java.lang.String quotaUser) {
      return (ForgetEntityFromGroup) super.setQuotaUser(quotaUser);
    }

    @Override
    public ForgetEntityFromGroup setUserIp(java.lang.String userIp) {
      return (ForgetEntityFromGroup) super.setUserIp(userIp);
    }

    @Override
    public ForgetEntityFromGroup set(String parameterName, Object value) {
      return (ForgetEntityFromGroup) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "groupMemberSync".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link GroupMemberSync#execute()} method to invoke the remote operation.
   *
   * @param mobileNumber
   * @return the request
   */
  public GroupMemberSync groupMemberSync(java.lang.String mobileNumber) throws java.io.IOException {
    GroupMemberSync result = new GroupMemberSync(mobileNumber);
    initialize(result);
    return result;
  }

  public class GroupMemberSync extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.GroupMemberSyncBeanCollection> {

    private static final String REST_PATH = "groupMemberSync/{mobileNumber}";

    /**
     * Create a request for the method "groupMemberSync".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link GroupMemberSync#execute()} method to invoke the remote
     * operation. <p> {@link GroupMemberSync#initialize(com.google.api.client.googleapis.services.Abst
     ...
     * @since 1.13
     */
    protected GroupMemberSync(java.lang.String mobileNumber) {
      super(TweetApi.this, "POST", REST_PATH, null, com.brahminno.tweetloc.backend.tweetApi.model.GroupMemberSyncBeanCollection.class);
    ...
    @Override
    public GroupMemberSync setAlt(java.lang.String alt) {
      return (GroupMemberSync) super.setAlt(alt);
    }

    @Override
    public GroupMemberSync setFields(java.lang.String fields) {
      return (GroupMemberSync) super.setFields(fields);
    }

    @Override
    public GroupMemberSync setKey(java.lang.String key) {
      return (GroupMemberSync) super.setKey(key);
    }

    @Override
    public GroupMemberSync setOauthToken(java.lang.String oauthToken) {
      return (GroupMemberSync) super.setOauthToken(oauthToken);
    }

    @Override
    public GroupMemberSync setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GroupMemberSync) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GroupMemberSync setQuotaUser(java.lang.String quotaUser) {
      return (GroupMemberSync) super.setQuotaUser(quotaUser);
    }

    @Override
    public GroupMemberSync setUserIp(java.lang.String userIp) {
      return (GroupMemberSync) super.setUserIp(userIp);
    }
    ...
    public GroupMemberSync setMobileNumber(java.lang.String mobileNumber) {
      this.mobileNumber = mobileNumber;
      return this;
    }

    @Override
    public GroupMemberSync set(String parameterName, Object value) {
      return (GroupMemberSync) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "memberAcceptanceStatus".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link MemberAcceptanceStatus#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean}
   * @return the request
   */
  public MemberAcceptanceStatus memberAcceptanceStatus(com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean content) throws java.io.IOException {
    MemberAcceptanceStatus result = new MemberAcceptanceStatus(content);
    initialize(result);
    return result;
  }

  public class MemberAcceptanceStatus extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean> {

    private static final String REST_PATH = "memberAcceptanceStatus";

    /**
     * Create a request for the method "memberAcceptanceStatus".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link MemberAcceptanceStatus#execute()} method to invoke the
     * remote operation. <p> {@link MemberAcceptanceStatus#initialize(com.google.api.client.googleapis
     * .services.AbstractGoogleClientRequest)} must be called to initialize this instance immediately
     * after invoking the constructor. </p>
     *
     * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean}
     * @since 1.13
     */
    protected MemberAcceptanceStatus(com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean content) {
      super(TweetApi.this, "POST", REST_PATH, content, com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean.class);
    }

    @Override
    public MemberAcceptanceStatus setAlt(java.lang.String alt) {
      return (MemberAcceptanceStatus) super.setAlt(alt);
    }

    @Override
    public MemberAcceptanceStatus setFields(java.lang.String fields) {
      return (MemberAcceptanceStatus) super.setFields(fields);
    }

    @Override
    public MemberAcceptanceStatus setKey(java.lang.String key) {
      return (MemberAcceptanceStatus) super.setKey(key);
    }

    @Override
    public MemberAcceptanceStatus setOauthToken(java.lang.String oauthToken) {
      return (MemberAcceptanceStatus) super.setOauthToken(oauthToken);
    }

    @Override
    public MemberAcceptanceStatus setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (MemberAcceptanceStatus) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public MemberAcceptanceStatus setQuotaUser(java.lang.String quotaUser) {
      return (MemberAcceptanceStatus) super.setQuotaUser(quotaUser);
    }

    @Override
    public MemberAcceptanceStatus setUserIp(java.lang.String userIp) {
      return (MemberAcceptanceStatus) super.setUserIp(userIp);
    }

    @Override
    public MemberAcceptanceStatus set(String parameterName, Object value) {
      return (MemberAcceptanceStatus) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "processAcceptanceStatusRequest".
   *
   * This request holds the parameters needed by the tweetApi server.  After setting any optional
   * parameters, call the {@link ProcessAcceptanceStatusRequest#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean}
   * @return the request
   */
  public ProcessAcceptanceStatusRequest processAcceptanceStatusRequest(com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean content) throws java.io.IOException {
    ProcessAcceptanceStatusRequest result = new ProcessAcceptanceStatusRequest(content);
    initialize(result);
    return result;
  }

  public class ProcessAcceptanceStatusRequest extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBeanCollection> {

    private static final String REST_PATH = "processAcceptanceStatusRequest";

    /**
     * Create a request for the method "processAcceptanceStatusRequest".
     *
     * This request holds the parameters needed by the the tweetApi server.  After setting any
     * optional parameters, call the {@link ProcessAcceptanceStatusRequest#execute()} method to invoke
     * the remote operation. <p> {@link ProcessAcceptanceStatusRequest#initialize(com.google.api.clien
     ...
     * @since 1.13
     */
    protected ProcessAcceptanceStatusRequest(com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBean content) {
      super(TweetApi.this, "POST", REST_PATH, content, com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBeanCollection.class);
    }

    @Override
    public ProcessAcceptanceStatusRequest setAlt(java.lang.String alt) {
      return (ProcessAcceptanceStatusRequest) super.setAlt(alt);
    }

    @Override
    public ProcessAcceptanceStatusRequest setFields(java.lang.String fields) {
      return (ProcessAcceptanceStatusRequest) super.setFields(fields);
    }

    @Override
    public ProcessAcceptanceStatusRequest setKey(java.lang.String key) {
      return (ProcessAcceptanceStatusRequest) super.setKey(key);
    }

    @Override
    public ProcessAcceptanceStatusRequest setOauthToken(java.lang.String oauthToken) {
      return (ProcessAcceptanceStatusRequest) super.setOauthToken(oauthToken);
    }

    @Override
    public ProcessAcceptanceStatusRequest setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ProcessAcceptanceStatusRequest) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ProcessAcceptanceStatusRequest setQuotaUser(java.lang.String quotaUser) {
      return (ProcessAcceptanceStatusRequest) super.setQuotaUser(quotaUser);
    }

    @Override
    public ProcessAcceptanceStatusRequest setUserIp(java.lang.String userIp) {
      return (ProcessAcceptanceStatusRequest) super.setUserIp(userIp);
    }

    @Override
    public ProcessAcceptanceStatusRequest set(String parameterName, Object value) {
      return (ProcessAcceptanceStatusRequest) super.set(parameterName, value);
    }
  }
