...
public class TweetApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param groupNameList
   * @param groupMemberMobileNumberList
   * @return the request
   */
  public ProcessAcceptanceStatusRequest processAcceptanceStatusRequest(java.util.List<java.lang.String> groupNameList, java.util.List<java.lang.String> groupMemberMobileNumberList) throws java.io.IOException {
    ProcessAcceptanceStatusRequest result = new ProcessAcceptanceStatusRequest(groupNameList, groupMemberMobileNumberList);
    initialize(result);
    return result;
  }
  ...
  public class ProcessAcceptanceStatusRequest extends TweetApiRequest<com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBeanCollection> {
    ...
    private static final String REST_PATH = "processAcceptanceStatusRequest/{groupNameList}/{groupMemberMobileNumberList}";
     ...
     * @since 1.13
     */
    protected ProcessAcceptanceStatusRequest(java.util.List<java.lang.String> groupNameList, java.util.List<java.lang.String> groupMemberMobileNumberList) {
      super(TweetApi.this, "POST", REST_PATH, null, com.brahminno.tweetloc.backend.tweetApi.model.AcceptanceStatusBeanCollection.class);
      this.groupNameList = com.google.api.client.util.Preconditions.checkNotNull(groupNameList, "Required parameter groupNameList must be specified.");
      this.groupMemberMobileNumberList = com.google.api.client.util.Preconditions.checkNotNull(groupMemberMobileNumberList, "Required parameter groupMemberMobileNumberList must be specified.");
    }
    ...
    public ProcessAcceptanceStatusRequest setGroupNameList(java.util.List<java.lang.String> groupNameList) {
      this.groupNameList = groupNameList;
      return this;
    }

    @com.google.api.client.util.Key
    private java.util.List<java.lang.String> groupMemberMobileNumberList;

    /**

     */
    public java.util.List<java.lang.String> getGroupMemberMobileNumberList() {
      return groupMemberMobileNumberList;
    }

    public ProcessAcceptanceStatusRequest setGroupMemberMobileNumberList(java.util.List<java.lang.String> groupMemberMobileNumberList) {
      this.groupMemberMobileNumberList = groupMemberMobileNumberList;
      return this;
    }
